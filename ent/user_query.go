...
func (uq *UserQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*User, init func(*User), assign func(*User, *Session)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.SessionsTable)
		s.Join(joinT).On(s.C(session.FieldID), joinT.C(user.SessionsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.SessionsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.SessionsPrimaryKey[0]))
